# RozanaMart - AI & Developer Guidelines

Complete guide for developers and AI agents working with RozanaMart codebase.
...
- **Admin Dashboard** (React) - Order/product/user management
...
|-------|-----------------|-----------|
| **Frontend** | UI/UX, client-side state, form validation | `frontend/src/pages/*`, `frontend/src/components/*` |
| **Backend** | Data persistence, business logic, auth | `backend/models/*`, `backend/routes/*` |
...
- Docker support available (check project root for Dockerfile)
...
2. Verify cart → checkout flow in `frontend/src/pages/CartPage.jsx` and `CheckoutPage.jsx`
3. Backend: Review order creation in `backend/routes/orders.js`
4. Validate advance payment calculation logic

## 📚 Documentation References
- **API Endpoints**: See [API_DOCS.md](API_DOCS.md) for complete endpoint list
- **Features**: [FEATURES_CHECKLIST.md](FEATURES_CHECKLIST.md) for progress tracking
- **Setup**: [QUICK_START.md](QUICK_START.md) for environment setup
- **Deployment**: [READY_TO_LAUNCH.md](READY_TO_LAUNCH.md) for production checklist
- **Index**: [INDEX.md](INDEX.md) for full documentation structure
...
**Last Updated**: December 2025 | **For**: Developers & AI Agents
